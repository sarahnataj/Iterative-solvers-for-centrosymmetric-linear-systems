...
%     2D singular perturbation problem with homogeneous Dirichlet boundary conditions
...
elseif ecase==8
    ...
    disp('Preconditioned by the centrosymmetric part of the matrix');
end
...
for i=1:size(N,2)
    ...
    elseif ecase==8
        [N_nop(i),N_ilu(i),N_ixy(i),N_ilutp(i),N_ixytp(i)]=gmres_poisson(N(i),4);
    end
end
N,N_nop,N_ilu,N_ixy,N_ilutp,N_ixytp

semilogy(N,N_nop,'-o',N,N_ilu,'-o',N,N_ixy,'-o',N,N_ilutp,'-o',N,N_ixytp','-o','LineWidth',2)
