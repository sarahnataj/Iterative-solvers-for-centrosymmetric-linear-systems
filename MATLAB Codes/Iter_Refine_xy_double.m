% Given A, b be given in precision u. This algorithm solves 
% Ax = b using GMRES-based iterative refinement using XY factorization
% calculated in duoble precision.
%
...
%       uf = the precision at which the factorization of 𝐴 is computed = double,
...
[A, C, M]=PseudoSpectral_Biharmonic_varcoef(n+1,10);%2D variable coefficient biharmonic
