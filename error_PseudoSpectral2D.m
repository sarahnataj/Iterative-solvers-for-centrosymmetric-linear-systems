function [error, A]=error_PseudoSpectral2D(n,order)
...
%         Poisson/biharmonic equations  at the collocation points, u is the
%         approximated solution.
%         A is the second/fourth order spectral differentiation matrices,
%        
...
elseif order==4
    ...
    %DD=D*D;A=kron(B,speye(n-1))+kron(speye(n-1),B)+2*kron(DD(2:n,2:n), DD(2:n,2:n));
    u=A\f;   
