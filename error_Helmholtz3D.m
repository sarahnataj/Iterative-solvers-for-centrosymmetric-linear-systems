function [error, A]=error_Helmholtz3D(n,a)
% Calculate spectral differentiation (pseudospectral) matrix for 
% 3D Helmholtz equation, -(\Delta +a)u=f with homogeneous Dirichlet boundary conditions.
% Input: n is the number of interior collocation nodes,
%        a is the square of the wave number.
% Output: error=\|u-u_ex\|_{\infty}, uex is the exact solution of 3D 
%         Helmholtz equation at the collocation points, u is the 
%         approximated solution.
%         A is the associated spectral differentiation matrix for 3D Helmholtz
%         equation.
