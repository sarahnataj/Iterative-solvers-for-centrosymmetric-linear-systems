function [error, A]=error_PoissonSymLeg(n)
...
% Output:error=\|u-u_ex\|_{\infty}, uex is the exact solution of 2D
%        Poisson equation at the collocation points, u is the 
%        approximated solution. 
%        A is the associated SPD spectral differentiation matrix
%        
