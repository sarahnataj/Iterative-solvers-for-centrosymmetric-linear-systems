function [A,uex]=PseudoSpectral_Helmholtz3D(n,a)
% Calculate 3D second order spectral differentiation (pseudospectral) 
% matrix for 3D Helmholtz equation, -(\Delta +a)u=f
% Input: n is the number of interior collocation nodes,
%        a is the square of the wave number.
% Output: A is the 3D second spectral differentiation matrix for Helmholtz
%        equation.
